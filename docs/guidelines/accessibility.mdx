...
Accessibility is mandatory for future INFORM products. We are committed to creating inclusive experiences for all users, regardless of ability or technology. Therefore it is essential that all teams follow these guidelines to ensure compliance with WCAG 2.1 AA standards.

ELEVATE supports this: Every component, pattern, and guideline is designed to ensure inclusive experiences for all users, regardless of ability, technology, or circumstance.
