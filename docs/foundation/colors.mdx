...
The primary brand color used for key actions, links, and highlights.
...
<ColorRamp selector="primitives-color-gray-*" exclude="primitives-color-gray-0" />

### Success Colors

Used for positive feedback, confirmations, and successful states.

<ColorRamp selector="primitives-color-green-*" />

### Warning Colors

For cautions, important notices, and attention-grabbing elements.

<ColorRamp selector="primitives-color-orange-*" />

### Error Colors

For errors, destructive actions, and critical alerts.

<ColorRamp selector="primitives-color-red-*" />
