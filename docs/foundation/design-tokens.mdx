...
**Primitive Tokens** are named _base values_ that don't change - raw colors,
font sizes, spacing values - basically any design decision that can be expressed with a value.
...
/* Spacing primitives */
--elvt-primitives-spacing-4: 16px; /* Equals 1rem */
--elvt-primitives-spacing-8: 32px; /* Equals 2rem */
```
