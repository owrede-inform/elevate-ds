---
title: Colors
description: Brand colors, semantic colors, and accessibility-compliant palettes
sidebar_position: 3
...
<ColorRamp title="Blue" selector="primitives-color-blue-*" />

### Usage Examples (light mode)

- **Primary Actions** - Blue 500 for buttons, links, CTAs
- **Hover States** - Blue 600 for interactive feedback
- **Focus States** - Blue 500 for focus indicators
- **Backgrounds** - Blue 50 for subtle highlighting

## Semantic Color Palette

### Neutral Colors
<ColorRamp title="Gray" selector="primitives-color-gray-*" exclude="primitives-color-gray-0" />
Used for elements that do not need to grab attention or convey a certain information.

### Success Colors
<ColorRamp title="Green" selector="primitives-color-green-*" />
Used for positive feedback, confirmations, and successful states.

### Warning Colors
<ColorRamp title="Orange" selector="primitives-color-orange-*" />
For cautions, important notices, and attention-grabbing elements.

### Error Colors
<ColorRamp title="Orange" selector="primitives-color-red-*" />
