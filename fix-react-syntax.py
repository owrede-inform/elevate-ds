...
def convert_component_names(content):
    ...
    conversions = [
        ...
        ('ElvtLink', 'elvt-link'),
        ('ElvtMenu', 'elvt-menu'),
        ('ElvtMenuItem', 'elvt-menu-item'),
        ('ElvtMenuLabel', 'elvt-menu-label'),
        ('ElvtMutationObserver', 'elvt-mutation-observer'),
        ('ElvtNavigation', 'elvt-navigation'),
        ('ElvtNavigationItem', 'elvt-navigation-item'),
        ('ElvtNavigationLabel', 'elvt-navigation-label'),
        ('ElvtNotification', 'elvt-notification'),
        ('ElvtPaginator', 'elvt-paginator'),
        ('ElvtPopup', 'elvt-popup'),
        ('ElvtProgress', 'elvt-progress'),
        ('ElvtRadio', 'elvt-radio'),
        ('ElvtRadioGroup', 'elvt-radio-group'),
        ('ElvtResizeObserver', 'elvt-resize-observer'),
        ('ElvtSelect', 'elvt-select'),
        ('ElvtSelectOption', 'elvt-select-option'),
        ('ElvtSelectOptionGroup', 'elvt-select-option-group'),
        ('ElvtSkeleton', 'elvt-skeleton'),
        ('ElvtStack', 'elvt-stack'),
        ('ElvtStepper', 'elvt-stepper'),
        ('ElvtStepperItem', 'elvt-stepper-item'),
        ('ElvtSwitch', 'elvt-switch'),
        ('ElvtTable', 'elvt-table'),
        ('ElvtTableCell', 'elvt-table-cell'),
        ('ElvtTableColumn', 'elvt-table-column'),
        ('ElvtTableRow', 'elvt-table-row'),
        ('ElvtTab', 'elvt-tab'),
        ('ElvtTabGroup', 'elvt-tab-group'),
        ('ElvtTabPanel', 'elvt-tab-panel'),
        ('ElvtTextarea', 'elvt-textarea'),
        ('ElvtToolbar', 'elvt-toolbar'),
        ('ElvtTooltip', 'elvt-tooltip'),
        ('ElvtVisuallyHidden', 'elvt-visually-hidden'),
    ]
